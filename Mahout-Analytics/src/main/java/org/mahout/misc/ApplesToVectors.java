...
/**
 * Mahout Named & Dense Vector POCs
 * @author kuntal
 *
 */
public class ApplesToVectors {
  ...
  public static void main(String args[]) throws Exception {
    ...
    Path path = new Path("/home/kuntal/Downloads/apples");
    ...
    SequenceFile.Reader reader = new SequenceFile.Reader(fs, new Path("/home/kuntal/Downloads/apples"), conf);
